...
- **API reference** - Layout system, configuration, and extension APIs
...
└── api-reference/                  # API documentation
    ├── layouts.md                # Layout system specification
...
3. **Architecture:** Review the Layout vs Layout model in ROADMAP.md
